...
knitr::opts_knit$set(
  root.dir = "/Users/mjfrigaard/projects/pkgs/dopingdata/")
options(
  pillar.print_max = 25, 
  dplyr.print_max = 25,
  knitr.kable.NA = '',
...
The `substance_type` data has the `multiple_sr` column for identifying if an sanction included more than one substance:
...
mult_aaf_subs <- substance_types |>
  dplyr::filter(
    sanction_type == "analytical" & multiple_sr == TRUE)
mult_aaf_subs |> 
