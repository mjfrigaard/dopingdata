...
#>  $ sanction_date     : Date[1:693], format: "2026-07-31" "2026-07-29" ...
```
...
#>  $ multiple_sports   : logi [1:684] FALSE FALSE FALSE FALSE FALSE FALSE ...
```
...
#>  $ multiple_sports   : logi [1:703] FALSE FALSE FALSE FALSE FALSE FALSE ...
```
