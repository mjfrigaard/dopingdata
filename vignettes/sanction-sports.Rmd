...
I'm going to locate the most recently wrangled data file from the `inst/extdata/` folder:

```{r get_recent_path-sports, eval=FALSE}
get_recent_path(
  folder = "../inst/extdata/", 
  type = "csv")
✔ import code pasted to clipboard!
✔ use: readr::read_csv('../inst/extdata/usada_dates.csv')
```
