...
#' @export classify_wada_substances
#'
#' @description usada_data should be the table of sanctions from the United
#'     States Anti-Doping Agency: https://www.usada.org/news/sanctions. The
...
#'
#' @examples
#' usada_data <- readr::read_csv(
#'   "inst/extdata/raw/2023-01-13/2023-01-13-usada_data_raw.csv"
#' )
